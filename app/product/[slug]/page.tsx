               ...
               <div className="grid gap-8 md:grid-cols-2">
                  ...
                  <div className="md:py-8">
                    ...
                    <div className="mb-6 flex items-center gap-3 md:mb-10">
                       ...
                       <span className="text-sm text-gray-500 transition duration-100">57 Ratings</span>
                    </div>

                    <div className="mb-4">
                        <div className="flex items-end gap-2">
                             <span className="text-xl font-bold text-gray-800 md:text-2xl">#{data.price}</span>
                             <span className="mb-0.5 text-red-500 line-through">#{data.price + 100}</span>
                        </div>
                        <span className="text-sm text-gray-500">Incl. Vat plus shipping</span>
                    </div>

                    <div className="mb-6 flex item-center gap-2 text-gray-500">
